    ...
    <div className="sidebar">
      ...
      <div className="sidebar__buy">
        ...
        <div className="sidebar__delivery">
          ...
          <button type="submit" className={sidebarBtnClasses} id="sidebar-button-buy" onClick={handleClicksidebarBtn}>{sidebarBtnIsActive ? "Товар добавлен" : "Добавить в корзину"}</button>
